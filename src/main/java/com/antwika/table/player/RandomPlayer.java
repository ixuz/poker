    ...
    protected IEvent onPlayerActionRequest(PlayerActionRequest event) {
        ...
        if (event.getToCall() == 0) {
            if (rand < 75) {
                ...
                return new PlayerActionResponse(this, tableData, PlayerActionResponse.Type.BET, TableDataUtil.calcBetSize(tableData, this, 0.75f));
            }
        } else {
            if (rand < 50) {
                return new PlayerActionResponse(this, tableData, PlayerActionResponse.Type.FOLD, 0);
            } else if (canRaise && rand < 75) {
                return new PlayerActionResponse(this, tableData, PlayerActionResponse.Type.RAISE, TableDataUtil.calcBetSize(tableData, this, 0.75f));
            } else {
